...
//CreateNextBlock for
func (s *Support) CreateNextBlock(messages []*cb.Envelope, NumOfTransactionsInPool int) *cb.Block {
	return s.ReadWriter.CreateNextBlock(messages, NumOfTransactionsInPool)
}
